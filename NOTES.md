[Starlight docs](https://starlight.astro.build/components/using-components/)

[Plugin docs](https://starlight-blog-docs.vercel.app/guides/frontmatter)

## Todo
- [x] url says "blog", should say "posts"
