...
![GitHub Repo Creation](/src/assets/series/gh-actions/gh-create-repo.gif){: .shadow}
...
![GitHub Repo Clone](/src/assets/series/gh-actions/gh-clone-repo.gif){: .shadow}
...
![Docker Hub Access Token](/src/assets/series/gh-actions/gh-docker_hub_secret.png){: .shadow}
...
![GitHub Actions Secrets](/src/assets/series/gh-actions/gh-actions-secrets.png){: .shadow}
...
![GitHub Actions Tab](/src/assets/series/gh-actions/gh-actions-tab.png){: .shadow}
...
![GitHub Actions Pipeline](/src/assets/series/gh-actions/gh-actions-pipeline-view.png){: .shadow}
