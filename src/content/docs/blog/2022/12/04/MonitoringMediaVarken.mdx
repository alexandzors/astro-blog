...
![Container Building](/src/assets/series/grafana-guide/varken/grafana-varken_build.jpg){: .shadow }
...
![Container Image](/src/assets/series/grafana-guide/varken/grafana-varken_image.jpg){: .shadow }
...
![Maxmind Account Summary](/src/assets/series/grafana-guide/varken/grafana-varken_maxmind-acct_sum.jpg){: .shadow }

Click on the "Manage License Keys" option on the left side. Then click on "Generate new license key" when the page loads.

![Maxmind DB Keys](/src/assets/series/grafana-guide/varken/grafana-varken_maxmind-keys.jpg){: .shadow }

Add "varken" to the description label field and select "no" for the question in the box. Then click "confirm". 

![Maxmind Generate Key](/src/assets/series/grafana-guide/varken/grafana-varken_maxmind-gen_key.jpg){: .shadow }
...
![Maxmind New Key](/src/assets/series/grafana-guide/varken/grafana-varken_maxmind-new_key.jpg){: .shadow }
...
![Docker ps Command](/src/assets/series/grafana-guide/varken/grafana-varken_docker_ps.jpg){: .shadow }
...
![Varken Log](/src/assets/series/grafana-guide/varken/grafana-varken_log.jpg){: .shadow }
...
![Varken Flux Dashboard](/src/assets/series/grafana-guide/varken/grafana-varken_dashboard.jpg){: .shadow }
...
![Populated Varken Dashboard](/src/assets/series/grafana-guide/varken/grafana-varken_dashboard_pop.jpg){: .shadow }
