...
![Cloudflare Sign up Page](/src/assets/series/caddy/p1/caddy_cf_signup.webp){: .shadow }
...
![Cloudflare Billing Info](/src/assets/series/caddy/p1/caddy_cf_billing.webp){: .shadow }
_Cloudflare Billing Info_

Then head back to the dashboard and enter the domain registration page.

![Cloudflare Domain Registering Menu](/src/assets/series/caddy/p1/caddy_cf_dash.webp){: .shadow }
...
![Cloudflare Domain Registering](/src/assets/series/caddy/p1/caddy_cf_register-domain.webp){: .shadow }
...
![Cloudflare Domain Active](/src/assets/series/caddy/p1/caddy_cf_active_domain.webp){: .shadow }
...
![Installing Docker GIF](/src/assets/series/caddy/p1/caddy_docker-install.webp){: .shadow }
_Installing Docker_
...
![Add user to Docker group](/src/assets/series/caddy/p1/caddy_docker_grpadd.webp){: .shadow }
...
![Docker command help](/src/assets/series/caddy/p1/caddy_dockercmd_help.webp){: .shadow }
...
![New Docker network and config directories](/src/assets/series/caddy/p1/caddy_dockernet-dir.webp){: .shadow }
...
![Navigating to the API Tokens page in Cloudflare](/src/assets/series/caddy/p1/caddy_cf_profile.webp){: .shadow }
...
![Cloudflare API template page](/src/assets/series/caddy/p1/caddy_cf_api-template.webp){: .shadow }
...
![Cloudflare API Token Setup](/src/assets/series/caddy/p1/caddy_cf_api-token.webp){: .shadow }
...
![Cloudflare API Token](/src/assets/series/caddy/p1/caddy_cf_new-token.webp){: .shadow }
...
![Cloudflare Zero Trust ](/src/assets/series/caddy/p1/caddy_cf_zero-trust.webp){: .shadow }
...
![Cloudflare Tunnels](/src/assets/series/caddy/p1/caddy_cf_tunnels-dash.webp){: .shadow }
_Cloudflare Tunnels menu option_

Now click on the "+ Create a tunnel" button on the Tunnels overview page.

![Cloudflare Tunnels Overview](/src/assets/series/caddy/p1/caddy_cf_create-tun.png){: .shadow }
...
![Cloudflare Tunnel Creation Wizard Part 1](/src/assets/series/caddy/p1/caddy_cf_tunnel-setup-1.webp){: .shadow }
...
![Edit Docker Run Command for the Tunnel](/src/assets/series/caddy/p1/caddy_cf_copy-token.webp){: .shadow }
...
![Example Cloudflare Tunnel Config](/src/assets/series/caddy/p1/caddy_docker_cf-setup.webp){: .shadow }
...
![Local Tunnel Connecting to Cloudflare](/src/assets/series/caddy/p1/caddy_cf_tunnel-connect.webp){: .shadow }
...
![Route tunnel example](/src/assets/series/caddy/p1/caddy_cf_tunnel-route.webp){: .shadow }
...
![Tunnel SNI config](/src/assets/series/caddy/p1/caddy_cf_tunnel-sni.webp){: .shadow }
_Tunnel SNI config_
...
![Online and Connected Tunnel](/src/assets/series/caddy/p1/caddy_cf_connected-tunnel.webp){: .shadow }
...
![Tunnel Entry in DNS Records](/src/assets/series/caddy/p1/caddy_cf_tunnel-record.webp){: .shadow }
...
![Example Transform Rule](/src/assets/series/caddy/p1/caddy_cf_transform-rule.webp){: .shadow }
...
![Cloudflare SSL/TLS Setting](/src/assets/series/caddy/p1/caddy_cf_ssl-setting.webp){: .shadow }
...
![Deploying Caddy with staging acme server](/src/assets/series/caddy/p1/caddy_staging_deploy.webp){: .shadow }
...
![I'm Alive!](/src/assets/series/caddy/p1/caddy_prod_deploy.webp){: .shadow}
_I'm Alive!_
