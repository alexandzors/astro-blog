...
![Plan Meme](https://media.makeameme.org/created/heres-the-plan-745ca82725.jpg){: .shadow}
...
![Notify Examples](/src/assets/posts/2023/09/12/ntfy_app_examples.webp){: .shadow }
...
![ntfy.sh web app](/src/assets/posts/2023/09/12/ntfy_web.webp){: .shadow }
...
web-root: "disable"
```
{: file="EXAMPLE server.yml"}

`CTRL`+ `x` then `y` to save and close the file.

![Disabled web client](/src/assets/posts/2023/09/12/ntfy_web_disabled.webp){: .shadow }
...
![Adding ntfy user](/src/assets/posts/2023/09/12/ntfy_user_add.webp)
...
![Setting user access](/src/assets/posts/2023/09/12/ntfy_user_access.webp){: .shadow}
...
![Creating access token](/src/assets/posts/2023/09/12/ntfy_user_token.webp){: .shadow }
...
![Token example](/src/assets/posts/2023/09/12/ntfy_user_token_ex.webp){: .shadow }
...
```
{: file="EXAMPLE /bin/sshd-login-ntfy"}
...
![ntfy app users](/src/assets/posts/2023/09/12/ntfy_app_users.webp){: .shadow width="200" height="600" .right }
...
![Example of notifications coming in](/src/assets/posts/2023/09/12/ntfy_notifications_example.webp){: .shadow }
