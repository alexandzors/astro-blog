...
draft: false
slug: posts/2022/06/20/AutoGHActionsDiun
---
...
In my [previous post](/posts/2022/06/12/AutoGHActionsDocker/), we got our [GitHub Actions](https://github.com/features/actions) pipeline set up and built our first Docker container image based on [Caddy](https://caddyserver.com/). In this post, we will be covering the process of automating the pipeline based on upstream changes in the parent [Caddy](https://hub.docker.com/_/caddy) Docker image. For this we will be deploying a service called [Diun](https://crazymax.dev/diun/) on a local docker machine.

<Aside type="note" title="What is Diun?">
...
<Aside type="tip">
  If you are using an older version of Docker Compose you will need to change the container name to `diun_diun_1`.
</Aside>
...
![Repository Dispatch Example](/src/assets/posts_images/2022/06/20/gh-actions-repo-dispatch.jpeg)
...
![Diun Discord Notification](/src/assets/posts_images/2022/06/20/gh-actions-discord-notif.png)
