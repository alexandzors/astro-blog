...
draft: false
slug: posts/2022/06/30/AutoGHBinary
---
...
```sh title="./scripts/caddybuild.sh" showLineNumbers=false
...
```sh title="./scripts/caddybuild-win64.sh" showLineNumbers=false
...
![GitHub Release](/src/assets/posts_images/2022/06/30/gh-actions-repo-release.png)
