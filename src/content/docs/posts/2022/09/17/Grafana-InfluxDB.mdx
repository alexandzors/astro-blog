...
![InfluxDB Welcome to InfluxDB](/src/assets/series/grafana-guide/grafana-influx-start.jpeg){: .shadow }
...
![InfluxDB Wizard Complete](/src/assets/series/grafana-guide/grafana-influx_setup_complete.jpeg){: .shadow }
...
![InfluxDB Data Explorer](/src/assets/series/grafana-guide/grafana-influxdb_dataxp.jpg){: .shadow}
...
2. Click Data Sources in the menu pop up
    ...
    ![Grafana Data Source](/src/assets/series/grafana-guide/grafana-add_prometheus_1.jpg){: .shadow}

3. Click "Add data source" button

    ![Grafana Data Source 2](/src/assets/series/grafana-guide/grafana-add_influx_DS.jpg){: .shadow}

4. Select InfluxDB from the list of sources

    ![Grafana Data Source 3](/src/assets/series/grafana-guide/grafana-select_influx_DS.jpg){: .shadow}
...
5. Enter the following information into the Settings for the InfluxDB data source.
  ...
  - (optional) Default Bucket: **telegraf**
    ...
    ![Grafana Data Source 4](/src/assets/series/grafana-guide/grafana-add_influx.jpg){: .shadow}
...
![Grafana InfluxDB Telegraf Panel CPU %](/src/assets/series/grafana-guide/grafana-influx_cont_cpu.jpg){: .shadow}
