...
excerpt: A bonus post for the GitHub Action series showing how to deploy jekyll to a Linode VM.
date: 2022-08-15
...
draft: false
slug: posts/2022/08/15/DeployJekyllLinode
---
...
![Actions Workflow](/src/assets/posts_images/2022/08/15/gh-actions-jekyll.png)
...
```yml title="delete_artifacts.yml"
