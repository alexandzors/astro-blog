...
featured: false
cover:
  alt: Image depicting a cross section between the old and new website.
  image: /public/covers/2024/migrating-agent-to-astro_banner.webp
draft: false
slug: posts/2024/09/06/migrating-agnet-to-astro
---
...
![](/src/assets/posts_images/2024/09/06/agnet-size.webp)
_Size of the new website dir_

![](/src/assets/posts_images/2024/09/06/agnet-psin.webp)
...
![](/src/assets/posts_images/2024/09/06/social-preview-image.png)
...
One of the things this theme did not have been a scroller/carousel (for testimonials/ratings). Which means I had to create one from scratch. It was easy enough to create a new component as it's a similar process to new pages. The component files live in the `/src/components` directory instead of the `/src/pages` one.
...
```html title="TestimonialCarousel.astro"
...
![](/src/assets/posts_images/2024/09/06/site-run-through.webp)
