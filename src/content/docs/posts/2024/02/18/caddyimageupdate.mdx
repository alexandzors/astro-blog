...
featured: false
draft: false
slug: posts/2024/02/18/caddyimageupdate
---
...
<Aside type="note">This is a third party build for [Caddy](https:///caddyserver.com/). Please do not use this in a production environment. This is merely available for me and anyone else that needs a quick docker image / binary with [these modules](https://github.com/alexandzors/caddy?tab=readme-ov-file#added-modules) already installed. You can always use the [download page](https://caddyserver.com/download) to generate your own binary or use the [official Docker image](https://hub.docker.com/_/caddy).</Aside>