...
featured: false
cover:
  alt: Image displaying the Forgejo logo.
  image: /public/covers/2024/upgradingforgejo_banner.webp
draft: false
slug: posts/2024/06/03/upgradingforgejo
---
...
```text title="access-credentials" showLineNumbers=false
Access_key: O3n9bNhrbadkeyAGKOuhIUzMGF
Secret_key: czgQT1fb1l3GD2nRQEPebadsecretbWG0xGIu20hjOeBfoSGo
```


```json title="Access Key User Policy" showLineNumbers=false
{
 "Version": "2012-10-17",
 "Statement": [
  {
...
![Create Access Key](/src/assets/posts_images/2024/06/03/fj-create-access-key.webp)
...
![`forgejo` bucket dir 1](/src/assets/posts_images/2024/06/03/fj-s3-dir_1.webp)
...
<Tabs>
  <TabItem label="MinIO Env Variables">
    ```yml title="forgejo-minio-env-example"
      # < truncated >
      environment:
        # Storage Configs
  ...
  <TabItem label="Full Compose Example">
  <Aside type="note">If you are curious about all the configuration options for Forgejo, you can check out the configuration cheat sheet [here](https://forgejo.org/docs/latest/admin/config-cheat-sheet/)</Aside>
...
![FJ Site Admin Config for LFS](/src/assets/posts_images/2024/06/03/fj-site-admin.webp)
...
![FJ Actions Meme](/src/assets/posts_images/2024/06/03/fj_actions_meme.webp)
...
![FJ Manage Runners](/src/assets/posts_images/2024/06/03/fj-manage-runners.webp)
...
![FJ Renovate PR](/src/assets/posts_images/2024/06/03/fj-renovate-pr.webp)
