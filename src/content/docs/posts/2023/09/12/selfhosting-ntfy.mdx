...
draft: false
slug: posts/2023/09/12/selfhosting-ntfy
---
...
<p style="text-align: center;">So in my <a href="/posts/2023/07/31/update">previous blog update post</a> I mentioned a few projects I was working on for posts on this blog. Well considering this post wasn't on the list it's time to toss the plan! Or did I really have a plan to begin with? :no_mouth:</p>
...
<Tabs>
  ...
  <TabItem label="Environment Example">
    If you do not want to mount the server.yml file for configuration, you can use environment variables to configure ntfy instead.
    ```yml
    services:
      server:
        restart: always
        ...
        environment:
          ...
          - NTFY_DEFAULT_HOST=https://ntfy.example.com
          - NTFY_LISTEN_HTTP=:80
...
```yml title="server.yml Example" showLineNumbers=false
default-host: "https://notify.yourdomain.com"
base-url: "https://notify.yourdomain.com"
listen-http: ":80"
cache-file: "/var/cache/ntfy/cache.db"
