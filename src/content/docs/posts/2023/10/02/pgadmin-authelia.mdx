...
featured: false
cover:
  alt: Image depicting the pgAdmin and Authelia logos.
  image: /public/covers/2023/pgadmin-authelia_banner.webp
draft: false
---
...
![OIDC Key + Cert](/src/assets/posts_images/2023/10/02/oidc_key-cert_pair.webp)
_Example output for private.key and public.crt_
...
![hmac secret](/src/assets/posts_images/2023/10/02/oidc_hmac.webp)
_Example of a hmac secret_
...
![Client secret](/src/assets/posts_images/2023/10/02/client_secret.webp)
_Example of a generated client secret_
...
<Aside type="danger">
  I know I shouldn't have to say it but 
  **DO NOT USE THE ABOVE VALUES. THESE ARE EXAMPLES.**
</Aside>

```dotenv title=".authelia.env"
# JWT Secret
...
![pgAdmin with Authelia signin](/src/assets/posts_images/2023/10/02/pgadmin_signin.webp)
_Example of my sign-in page for pgAdmin while OAuth is enabled_
...
![pgAdmin oAuth sign in flow](/src/assets/posts_images/2023/10/02/pgadmin_auth_login.webp)
_Example of the pgAdmin sign in flow with Authelia 2FA and master password prompt_
...
*Oh, and you bet I will be looking for a way to have notifications sent to [ntfy](/posts_images/2023/09/12/selfhosting-ntfy/) on successful authentications via Authelia.. haha........*
