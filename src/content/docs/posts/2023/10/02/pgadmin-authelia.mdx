...
![OIDC Key + Cert](/src/assets/posts/2023/09/30/oidc_key-cert_pair.webp){: .shadow }
...
![hmac secret](/src/assets/posts/2023/09/30/oidc_hmac.webp){: .shadow }
...
![Client secret](/src/assets/posts/2023/09/30/client_secret.webp){: .shadow }
    ...
    clients:
      - id: pgadmin
        ...
        response_modes:
          - query
```
{: file="configuration.yml" .nolineno}
...
-----END CERTIFICATE-----
```
{: file="oidc_issuer_cert" .nolineno }
...
-----END RSA PRIVATE KEY-----
```
{: file="oidc_private_key" .nolineno }
...
```
{: file="oidc_hmac_secret" .nolineno }
...
![pgAdmin with Authelia signin](/src/assets/posts/2023/09/30/pgadmin_signin.webp){: .shadow }
...
![pgAdmin oAuth sign in flow](/src/assets/posts/2023/09/30/pgadmin_auth_login.webp){: .shadow }
