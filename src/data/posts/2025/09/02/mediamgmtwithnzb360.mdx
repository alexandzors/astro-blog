...
The server is pretty much fully automatic with the help of a few media management apps. My family and I can request new content, and the backend apps will automatically procure it. The best part is that I can manage it all from my phone with a single app: <a href="https://nzb360.com" target="_blank">nzb360</a>.
...
Besides loathing about nzb360, I wanted to also have a sit down with Kev (the developer behind nzb360) and ask a few questions interview style. Enjoy!
